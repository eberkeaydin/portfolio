export const projects = [
  {
    title: 'AUT Coin',
    description: "AUT (Authic Coin) is a Ethereum based token that allows to user send, receive, approve and allowance functions with using a smart contract",
    image: '/images/autcoin.png',
    tags: ['Solidity', 'Smart Contracts', 'Ethereum'],
    source: 'https://github.com/eberkeaydin/ERC20-AUT-Coin',
    visit: 'https://ropsten.etherscan.io/address/0xde071c92de338ec3f6219e32386b6e99de644611',
    id: 0,
  },
  {
    title: 'Krypt Modern Ethereum Wallet',
    description:"Krypt provides a modern Web 3.0 ETH Wallet linked with Metamask. Thanks to smart contracts and Metamask, users can send and receive ETH free and safe via Krypt Solidity infrastructure.",
    image: '/images/1.png',
    tags: ['Solidity', 'React', 'Next.js', 'Tailwind CSS'],
    source: 'https://github.com/eberkeaydin/krypt-web3.0',
    visit: 'https://github.com/eberkeaydin/krypt-web3.0/',
    id: 1,
  },
  {
    ...
    visit: 'https://github.com/eberkeaydin/LinkedinMoodle-Database',
    id: 2,
  },
  // {
  ...
  //   visit: 'https://www.egesavtek.com/',
  //   id: 3,
  // },
  {
    title: 'Ege Defence Industry Summit Website',
    description: "Vanilla Javascript, SMTP Mail Protocol and Bootstrap 5.0 are used in this website. I was also co-organizator of this event.",
      image: '/images/essz.png',
      tags: ['Vanilla Javascript', 'HTML', 'CSS'],
    source: 'https://github.com/eberkeaydin/essz-website-2022',
    visit: 'https://egesavtek.com/zirve/',
    id: 4,
  }
];

export const TimeLineData = [
  { year: 2017, text: 'English Preparation School', },
  { year: 2018, text: 'Started my journey with Ege University Computer Engineering Department', },
