 ...
 */ export function generateAllParamCombinations(routeParamKeys, routeParams, rootParamKeys) {
    ...
    if (hadAllParamsGenerated || isRoutePPREnabled) {
        ...
        filterUniqueParams(routeParamKeys, validateParams(page, regex, isRoutePPREnabled, routeParamKeys, rootParamKeys, paramsToProcess)).forEach((params)=>{
            ...
            for (const key of routeParamKeys){
                ...
                pathname = pathname.replace(pattern, encodeParam(paramValue, (value)=>escapePathDelimiters(value, true)));
                encodedPathname = encodedPathname.replace(pattern, encodeParam(paramValue, encodeURIComponent));
            }
