import { APP_BUILD_MANIFEST, APP_PATHS_MANIFEST, BUILD_MANIFEST, INTERCEPTION_ROUTE_REWRITE_MANIFEST, MIDDLEWARE_BUILD_MANIFEST, MIDDLEWARE_MANIFEST, NEXT_FONT_MANIFEST, PAGES_MANIFEST, SERVER_REFERENCE_MANIFEST, TURBOPACK_CLIENT_BUILD_MANIFEST, TURBOPACK_CLIENT_MIDDLEWARE_MANIFEST, WEBPACK_STATS } from '../constants';
...
export class TurbopackManifestLoader {
    ...
    async loadClientBuildManifest(pageName, type) {
        if (type === void 0) type = 'pages';
        this.clientBuildManifests.set(getEntryKey(type, 'server', pageName), await readPartialManifest(this.distDir, TURBOPACK_CLIENT_BUILD_MANIFEST, pageName, type));
    }
    ...
    async writeBuildManifest(entrypoints, devRewrites, productionRewrites) {
        ...
        await writeFileAtomic(join(this.distDir, 'static', this.buildId, '_buildManifest.js'), clientBuildManifestJs);
