...
}, htmlFilepath: string, fileWriter: MultiFileWriter, experimental: Required<Pick<ExperimentalConfig, 'cacheComponents' | 'authInterrupts'>>, buildId: string): Promise<ExportRouteResult>;
